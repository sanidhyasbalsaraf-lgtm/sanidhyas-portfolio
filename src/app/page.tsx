  ...
  return (
    <div className="flex flex-col gap-20">
      <section className="flex flex-col gap-5">
        <p className="animate-fade-in-up text-sm font-medium tracking-wide text-accent">
          {site.location}
        </p>
        <h1
        ...
        >
          ...
          <Link
            href="/photography"
            className="rounded-full border border-border px-5 py-2.5 font-medium text-muted transition-all duration-200 hover:-translate-y-0.5 hover:border-accent hover:text-accent active:translate-y-0"
          >
            See photography
          </Link>
        </div>
